...
class DashboardFragment : Fragment(){
    ...
    override fun onCreateView(
        ...
        //получить интент для старта/останова сервиса
            ...
            override fun onItemBTDeviceClick(device: BTDevice) {
                view?.let {
                   ...
                   //bundleOf("macaddress" to device.mac))
                    ...
                    dashboardViewModel.currentState.setValue(device.mac)

                    val deviceConnect =
                            DeviceConnect(device.mac, device.name, ACTION_START_FOREGROUND_SERVICE)
        ...
        //остановить сервис с дисконнетком BT
...
//            //setEmptyText("<no bluetooth devices found>")
    ...
    private fun subscribeUi(adapter: BTDevicesAdapter) {
        ...
        dashboardViewModel.currentState.observe(viewLifecycleOwner, Observer { result ->
